...
describe('isBookLibraryFilePath', () => {
  it('rejects sibling paths that only share the book-library prefix', () => {
    ...
    expect(isBookLibraryFilePath('book-library.json', cwd, libraryRoot)).toBe(false)
    expect(isBookLibraryFilePath('book-library-backup/unit1.pdf', cwd, libraryRoot)).toBe(false)
    expect(isBookLibraryFilePath('book-library/../book-library-backup/unit1.pdf', cwd, libraryRoot)).toBe(false)
  })
})
